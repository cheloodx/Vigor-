...
struct CarPart: Identifiable {
    ...
    static var allParts: [CarPart] {
        [
            ...
            CarPart(name: "Baterie", icon: "battery.100.bolt", position: CGPoint(x: 110, y: 60), healthPercent: 55, hasIssue: true, statusLabel: "Capacitate redusa", description: "Bateria are capacitate redusa. Tensiunea scade sub 12V la pornire.", recommendations: ["Inlocuire baterie recomandata", "Verificare alternator"], estimatedCost: 400),
            ...
            CarPart(name: "Faruri", icon: "light.beacon.max", position: CGPoint(x: 40, y: 70), healthPercent: 95, hasIssue: false, statusLabel: "Excelente", description: "Toate luminile functioneaza corect. Becurile sunt in stare buna.", recommendations: [], estimatedCost: 0),
        ]
    }
}
