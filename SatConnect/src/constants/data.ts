...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      'Roaming internațional (175+ țări)',
      'eSIM global inclus',
...
export const MOCK_ESIM_CARDS: ESIMCard[] = [
  {
    ...
    label: 'România - Național',
    carrier: 'SatConnect RO',
    country: 'România',
    countryFlag: '🇷🇴',
    dataLimit: '10 GB',
    dataUsed: '3.2 GB',
  ...
  },
  {
    ...
    label: 'Europa - Roaming',
    carrier: 'SatConnect EU',
    country: 'Europa (175 țări)',
    countryFlag: '🇪🇺',
    dataLimit: '5 GB',
    dataUsed: '1.1 GB',
    dataUsedMB: 1126,
  ...
  },
  {
    ...
    label: 'Global - Satelit',
    carrier: 'SatConnect Global',
    country: 'Global (via satelit)',
    countryFlag: '🌍',
    dataLimit: '2 GB',
    dataUsed: '0 MB',
    dataUsedMB: 0,
