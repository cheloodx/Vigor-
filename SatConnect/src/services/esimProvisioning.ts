...
// ---------------------------------------------------------------------------
// Per-country plans — at-cost pricing (profit comes from app subscription)
// Prices are the lowest on the market, no markup on eSIM data
// ---------------------------------------------------------------------------
...
const COUNTRY_PLANS: Record<string, ESIMCountryPlan[]> = {
  // --- EUROPA ---
  RO: [
    makePlan('ro-1gb', 'RO', 'România', '🇷🇴', 1024, '1 GB', 7, 0.49, false),
    makePlan('ro-3gb', 'RO', 'România', '🇷🇴', 3072, '3 GB', 15, 0.99, false),
    makePlan('ro-5gb', 'RO', 'România', '🇷🇴', 5120, '5 GB', 30, 1.49, false),
    makePlan('ro-10gb', 'RO', 'România', '🇷🇴', 10240, '10 GB', 30, 2.49, true),
    makePlan('ro-20gb', 'RO', 'România', '🇷🇴', 20480, '20 GB', 30, 3.99, false),
    makePlan('ro-50gb', 'RO', 'România', '🇷🇴', 51200, '50 GB', 30, 7.99, false),
  ],
  FR: [
    makePlan('fr-1gb', 'FR', 'Franța', '🇫🇷', 1024, '1 GB', 7, 0.69, false),
    makePlan('fr-3gb', 'FR', 'Franța', '🇫🇷', 3072, '3 GB', 15, 1.49, false),
    makePlan('fr-5gb', 'FR', 'Franța', '🇫🇷', 5120, '5 GB', 30, 1.99, false),
    makePlan('fr-10gb', 'FR', 'Franța', '🇫🇷', 10240, '10 GB', 30, 3.49, true),
    makePlan('fr-20gb', 'FR', 'Franța', '🇫🇷', 20480, '20 GB', 30, 5.49, false),
    makePlan('fr-50gb', 'FR', 'Franța', '🇫🇷', 51200, '50 GB', 30, 9.99, false),
  ],
  DE: [
    makePlan('de-1gb', 'DE', 'Germania', '🇩🇪', 1024, '1 GB', 7, 0.69, false),
    makePlan('de-3gb', 'DE', 'Germania', '🇩🇪', 3072, '3 GB', 15, 1.49, false),
    makePlan('de-5gb', 'DE', 'Germania', '🇩🇪', 5120, '5 GB', 30, 1.99, false),
    makePlan('de-10gb', 'DE', 'Germania', '🇩🇪', 10240, '10 GB', 30, 3.49, true),
    makePlan('de-20gb', 'DE', 'Germania', '🇩🇪', 20480, '20 GB', 30, 5.49, false),
    makePlan('de-50gb', 'DE', 'Germania', '🇩🇪', 51200, '50 GB', 30, 9.99, false),
  ],
  IT: [
    makePlan('it-1gb', 'IT', 'Italia', '🇮🇹', 1024, '1 GB', 7, 0.69, false),
    makePlan('it-3gb', 'IT', 'Italia', '🇮🇹', 3072, '3 GB', 15, 1.29, false),
    makePlan('it-5gb', 'IT', 'Italia', '🇮🇹', 5120, '5 GB', 30, 1.99, false),
    makePlan('it-10gb', 'IT', 'Italia', '🇮🇹', 10240, '10 GB', 30, 3.49, true),
    makePlan('it-20gb', 'IT', 'Italia', '🇮🇹', 20480, '20 GB', 30, 5.49, false),
    makePlan('it-50gb', 'IT', 'Italia', '🇮🇹', 51200, '50 GB', 30, 9.99, false),
  ],
  ES: [
    makePlan('es-1gb', 'ES', 'Spania', '🇪🇸', 1024, '1 GB', 7, 0.69, false),
    makePlan('es-3gb', 'ES', 'Spania', '🇪🇸', 3072, '3 GB', 15, 1.29, false),
    makePlan('es-5gb', 'ES', 'Spania', '🇪🇸', 5120, '5 GB', 30, 1.99, false),
    makePlan('es-10gb', 'ES', 'Spania', '🇪🇸', 10240, '10 GB', 30, 3.49, true),
    makePlan('es-20gb', 'ES', 'Spania', '🇪🇸', 20480, '20 GB', 30, 5.49, false),
    makePlan('es-50gb', 'ES', 'Spania', '🇪🇸', 51200, '50 GB', 30, 9.99, false),
  ],
  GB: [
    makePlan('gb-1gb', 'GB', 'Marea Britanie', '🇬🇧', 1024, '1 GB', 7, 0.79, false),
    makePlan('gb-3gb', 'GB', 'Marea Britanie', '🇬🇧', 3072, '3 GB', 15, 1.69, false),
    makePlan('gb-5gb', 'GB', 'Marea Britanie', '🇬🇧', 5120, '5 GB', 30, 2.49, false),
    makePlan('gb-10gb', 'GB', 'Marea Britanie', '🇬🇧', 10240, '10 GB', 30, 3.99, true),
    makePlan('gb-20gb', 'GB', 'Marea Britanie', '🇬🇧', 20480, '20 GB', 30, 6.49, false),
    makePlan('gb-50gb', 'GB', 'Marea Britanie', '🇬🇧', 51200, '50 GB', 30, 11.99, false),
  ],
  GR: [
    makePlan('gr-1gb', 'GR', 'Grecia', '🇬🇷', 1024, '1 GB', 7, 0.69, false),
    makePlan('gr-3gb', 'GR', 'Grecia', '🇬🇷', 3072, '3 GB', 15, 1.29, false),
    makePlan('gr-5gb', 'GR', 'Grecia', '🇬🇷', 5120, '5 GB', 30, 1.99, false),
    makePlan('gr-10gb', 'GR', 'Grecia', '🇬🇷', 10240, '10 GB', 30, 3.49, true),
    makePlan('gr-20gb', 'GR', 'Grecia', '🇬🇷', 20480, '20 GB', 30, 5.49, false),
    makePlan('gr-50gb', 'GR', 'Grecia', '🇬🇷', 51200, '50 GB', 30, 9.99, false),
  ],
  TR: [
    makePlan('tr-1gb', 'TR', 'Turcia', '🇹🇷', 1024, '1 GB', 7, 0.49, false),
    makePlan('tr-3gb', 'TR', 'Turcia', '🇹🇷', 3072, '3 GB', 15, 0.99, false),
    makePlan('tr-5gb', 'TR', 'Turcia', '🇹🇷', 5120, '5 GB', 30, 1.49, false),
    makePlan('tr-10gb', 'TR', 'Turcia', '🇹🇷', 10240, '10 GB', 30, 2.49, true),
    makePlan('tr-20gb', 'TR', 'Turcia', '🇹🇷', 20480, '20 GB', 30, 3.99, false),
    makePlan('tr-50gb', 'TR', 'Turcia', '🇹🇷', 51200, '50 GB', 30, 7.99, false),
  ],
  // --- ASIA ---
  JP: [
    makePlan('jp-1gb', 'JP', 'Japonia', '🇯🇵', 1024, '1 GB', 7, 0.79, false),
    makePlan('jp-3gb', 'JP', 'Japonia', '🇯🇵', 3072, '3 GB', 15, 1.69, false),
    makePlan('jp-5gb', 'JP', 'Japonia', '🇯🇵', 5120, '5 GB', 30, 2.49, false),
    makePlan('jp-10gb', 'JP', 'Japonia', '🇯🇵', 10240, '10 GB', 30, 3.99, true),
    makePlan('jp-20gb', 'JP', 'Japonia', '🇯🇵', 20480, '20 GB', 30, 6.49, false),
    makePlan('jp-50gb', 'JP', 'Japonia', '🇯🇵', 51200, '50 GB', 30, 11.99, false),
  ],
  KR: [
    makePlan('kr-1gb', 'KR', 'Coreea de Sud', '🇰🇷', 1024, '1 GB', 7, 0.79, false),
    makePlan('kr-3gb', 'KR', 'Coreea de Sud', '🇰🇷', 3072, '3 GB', 15, 1.69, false),
    makePlan('kr-5gb', 'KR', 'Coreea de Sud', '🇰🇷', 5120, '5 GB', 30, 2.49, false),
    makePlan('kr-10gb', 'KR', 'Coreea de Sud', '🇰🇷', 10240, '10 GB', 30, 3.99, true),
    makePlan('kr-20gb', 'KR', 'Coreea de Sud', '🇰🇷', 20480, '20 GB', 30, 6.49, false),
    makePlan('kr-50gb', 'KR', 'Coreea de Sud', '🇰🇷', 51200, '50 GB', 30, 11.99, false),
  ],
  TH: [
    makePlan('th-1gb', 'TH', 'Thailanda', '🇹🇭', 1024, '1 GB', 7, 0.49, false),
    makePlan('th-3gb', 'TH', 'Thailanda', '🇹🇭', 3072, '3 GB', 15, 0.99, false),
    makePlan('th-5gb', 'TH', 'Thailanda', '🇹🇭', 5120, '5 GB', 30, 1.49, false),
    makePlan('th-10gb', 'TH', 'Thailanda', '🇹🇭', 10240, '10 GB', 30, 2.49, true),
    makePlan('th-20gb', 'TH', 'Thailanda', '🇹🇭', 20480, '20 GB', 30, 3.99, false),
    makePlan('th-50gb', 'TH', 'Thailanda', '🇹🇭', 51200, '50 GB', 30, 7.99, false),
  ],
  IN: [
    makePlan('in-1gb', 'IN', 'India', '🇮🇳', 1024, '1 GB', 7, 0.29, false),
    makePlan('in-3gb', 'IN', 'India', '🇮🇳', 3072, '3 GB', 15, 0.69, false),
    makePlan('in-5gb', 'IN', 'India', '🇮🇳', 5120, '5 GB', 30, 0.99, false),
    makePlan('in-10gb', 'IN', 'India', '🇮🇳', 10240, '10 GB', 30, 1.79, true),
    makePlan('in-20gb', 'IN', 'India', '🇮🇳', 20480, '20 GB', 30, 2.99, false),
    makePlan('in-50gb', 'IN', 'India', '🇮🇳', 51200, '50 GB', 30, 5.99, false),
  ],
  CN: [
    makePlan('cn-1gb', 'CN', 'China', '🇨🇳', 1024, '1 GB', 7, 0.99, false),
    makePlan('cn-3gb', 'CN', 'China', '🇨🇳', 3072, '3 GB', 15, 1.99, false),
    makePlan('cn-5gb', 'CN', 'China', '🇨🇳', 5120, '5 GB', 30, 2.99, false),
    makePlan('cn-10gb', 'CN', 'China', '🇨🇳', 10240, '10 GB', 30, 4.99, true),
    makePlan('cn-20gb', 'CN', 'China', '🇨🇳', 20480, '20 GB', 30, 7.99, false),
    makePlan('cn-50gb', 'CN', 'China', '🇨🇳', 51200, '50 GB', 30, 13.99, false),
  ],
  // --- AMERICAS ---
  US: [
    makePlan('us-1gb', 'US', 'SUA', '🇺🇸', 1024, '1 GB', 7, 0.99, false),
    makePlan('us-3gb', 'US', 'SUA', '🇺🇸', 3072, '3 GB', 15, 1.99, false),
    makePlan('us-5gb', 'US', 'SUA', '🇺🇸', 5120, '5 GB', 30, 2.99, false),
    makePlan('us-10gb', 'US', 'SUA', '🇺🇸', 10240, '10 GB', 30, 4.99, true),
    makePlan('us-20gb', 'US', 'SUA', '🇺🇸', 20480, '20 GB', 30, 7.99, false),
    makePlan('us-50gb', 'US', 'SUA', '🇺🇸', 51200, '50 GB', 30, 14.99, false),
  ],
  CA: [
    makePlan('ca-1gb', 'CA', 'Canada', '🇨🇦', 1024, '1 GB', 7, 0.99, false),
    makePlan('ca-3gb', 'CA', 'Canada', '🇨🇦', 3072, '3 GB', 15, 1.99, false),
    makePlan('ca-5gb', 'CA', 'Canada', '🇨🇦', 5120, '5 GB', 30, 2.99, false),
    makePlan('ca-10gb', 'CA', 'Canada', '🇨🇦', 10240, '10 GB', 30, 4.99, true),
    makePlan('ca-20gb', 'CA', 'Canada', '🇨🇦', 20480, '20 GB', 30, 7.99, false),
    makePlan('ca-50gb', 'CA', 'Canada', '🇨🇦', 51200, '50 GB', 30, 14.99, false),
  ],
  MX: [
    makePlan('mx-1gb', 'MX', 'Mexic', '🇲🇽', 1024, '1 GB', 7, 0.49, false),
    makePlan('mx-3gb', 'MX', 'Mexic', '🇲🇽', 3072, '3 GB', 15, 0.99, false),
    makePlan('mx-5gb', 'MX', 'Mexic', '🇲🇽', 5120, '5 GB', 30, 1.49, false),
    makePlan('mx-10gb', 'MX', 'Mexic', '🇲🇽', 10240, '10 GB', 30, 2.49, true),
    makePlan('mx-20gb', 'MX', 'Mexic', '🇲🇽', 20480, '20 GB', 30, 3.99, false),
    makePlan('mx-50gb', 'MX', 'Mexic', '🇲🇽', 51200, '50 GB', 30, 7.99, false),
  ],
  BR: [
    makePlan('br-1gb', 'BR', 'Brazilia', '🇧🇷', 1024, '1 GB', 7, 0.49, false),
    makePlan('br-3gb', 'BR', 'Brazilia', '🇧🇷', 3072, '3 GB', 15, 0.99, false),
    makePlan('br-5gb', 'BR', 'Brazilia', '🇧🇷', 5120, '5 GB', 30, 1.49, false),
    makePlan('br-10gb', 'BR', 'Brazilia', '🇧🇷', 10240, '10 GB', 30, 2.49, true),
    makePlan('br-20gb', 'BR', 'Brazilia', '🇧🇷', 20480, '20 GB', 30, 3.99, false),
    makePlan('br-50gb', 'BR', 'Brazilia', '🇧🇷', 51200, '50 GB', 30, 7.99, false),
  ],
  // --- ORIENT MIJLOCIU & AFRICA ---
  EG: [
    makePlan('eg-1gb', 'EG', 'Egipt', '🇪🇬', 1024, '1 GB', 7, 0.69, false),
    makePlan('eg-3gb', 'EG', 'Egipt', '🇪🇬', 3072, '3 GB', 15, 1.29, false),
    makePlan('eg-5gb', 'EG', 'Egipt', '🇪🇬', 5120, '5 GB', 30, 1.99, false),
    makePlan('eg-10gb', 'EG', 'Egipt', '🇪🇬', 10240, '10 GB', 30, 3.49, true),
    makePlan('eg-20gb', 'EG', 'Egipt', '🇪🇬', 20480, '20 GB', 30, 5.49, false),
    makePlan('eg-50gb', 'EG', 'Egipt', '🇪🇬', 51200, '50 GB', 30, 9.99, false),
  ],
  AE: [
    makePlan('ae-1gb', 'AE', 'Emiratele Arabe', '🇦🇪', 1024, '1 GB', 7, 0.79, false),
    makePlan('ae-3gb', 'AE', 'Emiratele Arabe', '🇦🇪', 3072, '3 GB', 15, 1.69, false),
    makePlan('ae-5gb', 'AE', 'Emiratele Arabe', '🇦🇪', 5120, '5 GB', 30, 2.49, false),
    makePlan('ae-10gb', 'AE', 'Emiratele Arabe', '🇦🇪', 10240, '10 GB', 30, 3.99, true),
    makePlan('ae-20gb', 'AE', 'Emiratele Arabe', '🇦🇪', 20480, '20 GB', 30, 6.49, false),
    makePlan('ae-50gb', 'AE', 'Emiratele Arabe', '🇦🇪', 51200, '50 GB', 30, 11.99, false),
  ],
  // --- OCEANIA ---
  AU: [
    makePlan('au-1gb', 'AU', 'Australia', '🇦🇺', 1024, '1 GB', 7, 0.79, false),
    makePlan('au-3gb', 'AU', 'Australia', '🇦🇺', 3072, '3 GB', 15, 1.69, false),
    makePlan('au-5gb', 'AU', 'Australia', '🇦🇺', 5120, '5 GB', 30, 2.49, false),
    makePlan('au-10gb', 'AU', 'Australia', '🇦🇺', 10240, '10 GB', 30, 3.99, true),
    makePlan('au-20gb', 'AU', 'Australia', '🇦🇺', 20480, '20 GB', 30, 6.49, false),
    makePlan('au-50gb', 'AU', 'Australia', '🇦🇺', 51200, '50 GB', 30, 11.99, false),
  ],
  // --- PLANURI REGIONALE ---
  EU: [
    makePlan('eu-1gb', 'EU', 'Europa (30+ țări)', '🇪🇺', 1024, '1 GB', 7, 0.79, false),
    makePlan('eu-3gb', 'EU', 'Europa (30+ țări)', '🇪🇺', 3072, '3 GB', 15, 1.49, false),
    makePlan('eu-5gb', 'EU', 'Europa (30+ țări)', '🇪🇺', 5120, '5 GB', 30, 2.49, false),
    makePlan('eu-10gb', 'EU', 'Europa (30+ țări)', '🇪🇺', 10240, '10 GB', 30, 3.99, true),
    makePlan('eu-20gb', 'EU', 'Europa (30+ țări)', '🇪🇺', 20480, '20 GB', 30, 5.99, false),
    makePlan('eu-50gb', 'EU', 'Europa (30+ țări)', '🇪🇺', 51200, '50 GB', 30, 9.99, false),
  ],
  ASIA: [
    makePlan('asia-1gb', 'ASIA', 'Asia Pacific', '🌏', 1024, '1 GB', 7, 0.79, false),
    makePlan('asia-3gb', 'ASIA', 'Asia Pacific', '🌏', 3072, '3 GB', 15, 1.49, false),
    makePlan('asia-5gb', 'ASIA', 'Asia Pacific', '🌏', 5120, '5 GB', 30, 2.49, false),
    makePlan('asia-10gb', 'ASIA', 'Asia Pacific', '🌏', 10240, '10 GB', 30, 3.99, true),
    makePlan('asia-20gb', 'ASIA', 'Asia Pacific', '🌏', 20480, '20 GB', 30, 5.99, false),
    makePlan('asia-50gb', 'ASIA', 'Asia Pacific', '🌏', 51200, '50 GB', 30, 9.99, false),
  ],
  GLOBAL: [
    makePlan('global-1gb', 'GLOBAL', 'Global (175 țări)', '🌍', 1024, '1 GB', 7, 0.99, false),
    makePlan('global-3gb', 'GLOBAL', 'Global (175 țări)', '🌍', 3072, '3 GB', 15, 1.99, false),
    makePlan('global-5gb', 'GLOBAL', 'Global (175 țări)', '🌍', 5120, '5 GB', 30, 2.99, false),
    makePlan('global-10gb', 'GLOBAL', 'Global (175 țări)', '🌍', 10240, '10 GB', 30, 4.99, true),
    makePlan('global-20gb', 'GLOBAL', 'Global (175 țări)', '🌍', 20480, '20 GB', 30, 7.99, false),
    makePlan('global-50gb', 'GLOBAL', 'Global (175 țări)', '🌍', 51200, '50 GB', 30, 14.99, false),
  ],
};
...
function generateDefaultPlans(country: ESIMCountry): ESIMCountryPlan[] {
  ...
  return [
    makePlan(`${cc}-1gb`, country.code, country.name, country.flag, 1024, '1 GB', 7, 0.69, false),
    makePlan(`${cc}-3gb`, country.code, country.name, country.flag, 3072, '3 GB', 15, 1.29, false),
    makePlan(`${cc}-5gb`, country.code, country.name, country.flag, 5120, '5 GB', 30, 1.99, false),
    makePlan(`${cc}-10gb`, country.code, country.name, country.flag, 10240, '10 GB', 30, 3.49, true),
    makePlan(`${cc}-20gb`, country.code, country.name, country.flag, 20480, '20 GB', 30, 5.49, false),
    makePlan(`${cc}-50gb`, country.code, country.name, country.flag, 51200, '50 GB', 30, 9.99, false),
  ];
}
